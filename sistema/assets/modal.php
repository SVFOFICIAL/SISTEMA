...
<div  id="modal_contrato" class="flex flex-col bg-white relative w-full   max-h-full">

<div style="background: #7233A1;" class="w-full md:mx-auto flex-row justify-center flex lg:mx-0 text-white font-bold  py-4 px-10 shadow-lg focus:outline-none focus:shadow-outline">
...
<div class="m-5 flex flex-col">
                  ...
                  <div class="flex">
                    ...
                    <div style="position:relative;top:10px" class="icheck-material-green">

						          <input type="checkbox"  id="check_contrato" />
			                <label for="check_contrato">Eu declaro que li e concordo com o termos de uso.</label>
			            </div>
 
<div style="position:relative;top:25px" class="flex justify-end flex-row">	
      ...
      <div class="flex">	
					<button id="btn-cad" disabled style="background-color: #00BB07;width: 114px;"class="aceita_entrega button-disabled" >Aceitar</button>						
					</div>	 
			</div>	
         ...
         <div style="display:none;" id="modal_cad" class="relative w-full   max-h-full">
