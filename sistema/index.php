									...
									<div class="col-md-12 col-xs-12">
										<div class="row">
											<div class="col-md-12">
												...
												<div class="object-fit img-container justify-end">	
													<?php
														$img_logo = empty($img_logo) ? 'default/LOGOPADRAO.png' : $img_logo;
													?>	
													 										
													<img style="margin:auto;padding:5px" src="<?=URL_IMAGE.$img_logo?>"  height="200" width="200" alt="" data-retina="true" class="img-fluid">	 
													 
													 
															<a style="position:absolute;right:10px"title="Ajuda" href=""><img style="height:30px;margin:10px" src="<?=$site?>img/group_14.png"  height="30" width="30" data-retina="true"  ></a>	 
