          ...
          <div class="row">
             ...
             <div class="row">
               <div class="col-md-12">
                 <div class="form-group">
                   ...
                   <input placeholder="Nome do item"  maxlength="50" value="<?=$nome_item;?>" type="text"  name="nome_item" class="form-control">
                 </div>
               </div>
                  </div>
                  <div class="row">
            ...
            <div class="form-group">
             ...
             <div class="m-3 icheck-material-green">
						<input type="checkbox" name="dia_prod_todos" value="todos_checked" id="op_todos" />
            ...
            <div class="m-3 icheck-material-green">
				  <input type="checkbox" class="dias_prod" name="dia_prod"  value="Terça" id="op_terca" />
            ...
            <div class="m-3 icheck-material-green">
						<input type="checkbox" class="dias_prod" name="dia_prod" value="Sabado" id="op_sabado" />
