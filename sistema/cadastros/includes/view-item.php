      ...
      <div class="form-group">
        ...
        <br/>
            <div class="col-md-3">
             ...
             <div class="col-md-3">
                <div class="icheck-material-green">	        
                      <input type="checkbox" id="produtos_destaque" name="check_produtos_destaques" class="form-control">
                      <label for="produtos_destaque">Apenas produtos em destaque</label>	
                </div>
        ...
        <table id="produtos" class="border w-full text-left text-gray-500 dark:text-gray-400">
             <thead style="background:#7232A0;" class="text-white text-white md:text-md\[20px]  text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
              ...
              <th scope="col" class="text-center px-6 py-3">
                ...
                <th style="padding:25px;position: relative; top: unset;" scope="col" class="text-center px-6 py-3">Imagem</th>              
                ...
                <th scope="col" class="text-center px-6 py-3" data-sortable="false">Destaque</th>                  
                <th scope="col" class="text-center px-6 py-3" data-sortable="false">Ativo</th>                  
