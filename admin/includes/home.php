            ...
            <input oninput="this.value = this.value.replace(/[^a-z-A-Z-0-9]/g, '')"  type="text" id="search_cidade"  class="form-control" placeholder="Digite o nome da cidade">
                ...
                <div class="form-group">
                     <label for="search_cupom">Data Inicial:</label>						
                      ...
                      <input  type="text" class="search_date_from form-control" name='search_data_cadastro_from' id="datepicker-from" data-mask="00/00/0000" placeholder="00/00/0000" />
                    </div>
                </div>
                <div class="col-md-2">
                <div class="form-group">
                     <label for="search_cupom">Data Final:</label>					
                      ...
                      <input  type="text" class="search_date_to form-control" name='search_data_cadastro_to' id="datepicker-to" data-mask="00/00/0000" placeholder="00/00/0000" />
                    </div>
                </div>
