...
<div class="col-md-6" <?=($detect->isMobile() ? "style=\"padding-left: 2px;padding-right: 2px;\"" : "");?>>
	...
	<div class="box_style_2" id="main_menu" style="color:black" <?=($detect->isMobile() ? "style=\"padding-left: 2px;\"" : "");?>>
									...
									<tr>
										<td data-toggle="modal" data-target="#popuppedido_<?=$ido_DoItem;?>">
											...
											if (!empty($img_item) && $img_item != "null" && file_exists("uploads/{$img_item}") && !is_dir("uploads/{$img_item}")):										
												if($detect->isMobile()): 
													echo "<figure class=\"thumb_menu_list\">".Check::Image($img_item, 'Imagem-item', 180, 180)."</figure>";
...
if(!empty($disponivel) && $disponivel == 1):
	?>	
	<a style="cursor: pointer;" class="adicionarItemPedido_<?=$ido_DoItem;?>" id="btn-adicionar-item"><?=$texto['msg_purchase'];?></a>
	<script type="text/javascript">
		$(document).ready(function(){
