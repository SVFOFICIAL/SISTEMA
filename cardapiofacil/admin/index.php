...
<head>
  ...
  <title> S.V.F - Painel Administrativo</title>
  <!-- Bootstrap Core CSS -->
  ...
  <section id="wrapper" class="new-login-register">
    <div class="lg-info-panel">
      <div class="inner-panel">
          <br>
          <br>
        <img src="../plugins/images/admin-logo.png" height="250" width="350">
      </div>
    </div>
    ...
    <div class="form-group text-center m-t-20">
      <div class="col-xs-12">
        <button class="btn btn-info btn-lg btn-block btn-rounded text-uppercase waves-effect waves-light" style="background-color: purple" type="submit">Entrar</button>
      </div>
    </div>
  </form>
</div>
