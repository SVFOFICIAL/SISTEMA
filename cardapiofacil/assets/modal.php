        ...
        <div class="p-6">      
            ...
            <div id="cadastrar">
              <div class="main_title margin_mobile">
                ...
                <br />
                <p>
                 Garantia total de satisfação! Você está a um passo de agilizar seu atendimento.<br>
                 Ganhe gratuito <b style="color: #7233A1" style="font-size: 25px;"><?=$texto['DiasDeTeste'];?></b> dias para testar.
               </p>
             </div>
             <div class="row">
