...
if($isProduction) {    
    define('HOME', 'http://sistemasvf.com.br/cardapiofacil/'); // SEMPRE COM A BARRA NA FRENTE ---- ---- ---- ----
    define('UPLOAD_PATH', $_SERVER['DOCUMENT_ROOT'].'/sistema/uploads/');
    define('URL_IMAGE', 'http://sistemasvf.com.br/sistema/uploads/');
   
}else{
    define('HOME', 'http://192.168.18.4/svf/cardapiofacil/' ); // SEMPRE COM A BARRA NA FRENTE ---- ---- ---- ----
    define('UPLOAD_PATH', $_SERVER['DOCUMENT_ROOT'].'/svf/sistema/uploads/');
    define('URL_IMAGE', 'http://192.168.18.4/svf/sistema/uploads/');
}
