...
class Check {
 ...
 return $porcentagem; 
    ...
    public static function Image($ImageUrl, $ImageDesc, $ImageW = null, $ImageH = null) {
        ...
        if (file_get_contents($patch .self::$Data) && !is_dir($patch .self::$Data)):         
                       
            $imagem = self::$Data;
            return "<img class=\"lightbox\" src=\"{$site}tim.php?src={$url_image}{$imagem}&w={$ImageW}&h={$ImageH}\" alt=\"{$ImageDesc}\" title=\"{$ImageDesc}\"/>";
        else:
            return false;
        endif;
    }
